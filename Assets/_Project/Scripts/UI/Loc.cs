...
namespace TheVeil.UI
{
    ...
    public static class Loc
    {
        ...
        static readonly Dictionary<string, string> SwedishTable = new Dictionary<string, string>
        {
            ...
            ["HIRE A SCOUT  ·  {0} GOLD"] = "HYR EN SPEJARE  ·  {0} GULD",
            ["SCOUT HIRED FOR THIS LEVEL"] = "SPEJARE HYRD FÖR DENNA BANA",
            ...
            ["fireballs, 18 m, expensive"] = "eldklot, 18 m, dyr",
            ["34 m sight, walks ahead, does not fight"] = "34 m sikt, går före, slåss inte",
            ["takes 40 % less damage, draws attackers"] = "tar 40 % mindre skada, drar till sig anfall",
            ["heals the most wounded"] = "helar den mest sargade",
            ["disarms traps, mends wagons"] = "desarmerar fällor, lagar vagnar",
            ["hits harder than a bow, 20 m"] = "slår hårdare än en båge, 20 m",
            ["mailed horse, 15 % less damage"] = "brynjeklädd häst, tar 15 % mindre skada",
            ["hits harder, 20 % less damage"] = "slår hårdare, tar 20 % mindre skada",
            ["the heaviest charge, 25 % less damage"] = "tyngst anfall, tar 25 % mindre skada",
            ["opens after {0} cleared levels"] = "öppnas efter {0} klarade banor",
            ...
            ["Priest"] = "Präst",
            ["Engineer"] = "Ingenjör",
            ["Crossbowmen"] = "Armborstskyttar",
            ["Heavy Cavalry"] = "Tungt kavalleri",
            ["Noble Cavalry"] = "Adligt kavalleri",
            ["Knights"] = "Riddare",
            ["SPEAR"] = "SPJUT",
            ["SWORD"] = "SVÄRD",
            ["BOW"] = "BÅGE",
            ...
            ["{0} have no reach to buy — only bows, crossbows and staves shoot from afar."]
                = "{0} har ingen räckvidd att köpa — bara bågar, armborst och stavar skjuter på avstånd.",
            ["now {0}"] = "nu {0}",
