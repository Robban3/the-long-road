...
- **Smedjan (guld):** +60 % skada, +50 % liv och 15 % skadereduktion vid fullt spår, i **trettio jämna steg**. Stegen var tidigare framtunga — de tre första, som en enda vunnen bana betalar, gav en femtedel av allt spåret någonsin gav. Nu är varje steg värt lika mycket.
- **Truppen maxas i slutet av spelet.** En spelare som lägger ungefär halva guldet på trupperna och sprider det över uppställningen har den maxad vid bana ~975 av 1000: 2 steg av 30 efter kapitel 1, 12 efter 100 banor, 24 efter 500. Första steget kostar 30 guld och varje steg 12,3 % mer; ett fullt spår är runt 7 700 guld. Den som lägger *allt* guld på en enda trupp kan maxa den runt bana 140 — priset för att strunta i allt annat, och ändå långt efter ett kapitel. Låst i `BoonTests.TheLineIsFinishedAtTheEndOfTheCampaign` och `NoTroopIsFinishedWithinAChapter`.

**Två spelare som varje bana mäts mot.** *Kurvspelaren* har kurvans uppställning, lägger halva guldet på trupperna och handlar brett i fältsmedjan medan silvret kommer in. *Den förberedda spelaren* väljer uppställning efter vägen (kurvans, sköldmur med präst, tungt kavalleri, eller skyttar bakom sköld), lägger allt guld på trupperna den tar med och satsar djupt i fältsmedjan. Generatorn släpper aldrig en karta där den förberedda spelaren inte kommer ner för **varje** väg — ingen väg är en mur. Kurvspelaren kommer fram på den snabba vägen på ungefär 17 banor av 30, på den säkra på 28 och den långa på 29.
