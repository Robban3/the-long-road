...
- **Ingen trupp maxas på under 900 banor**, inte ens om allt guld läggs på den enda truppen. Första steget kostar 30 guld och varje steg 22 % mer än det förra: ett fullt spår är runt 53 000 guld, en trupp med två spår 965 banors guld och en med tre (båge, spejare) runt 1 450. Början är nästan som förut (30, 35, 45, 55, 65); slutet ligger långt bort. Regeln är låst i `BoonTests.NoTroopIsFinishedInUnderNineHundredLevels`.
