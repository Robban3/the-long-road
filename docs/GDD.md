...
**The Long Road** är spelet. **Legacy of the Veil** är världen det utspelar sig i och kan rymma fler titlar. Det här dokumentet beskriver spelet; världsmaterial som överlever enskilda titlar — biomer, folkslag, geografi, historia — hör hemma i ett separat världsdokument när det växer sig stort nog.
...
`TheVeil.Sim` bestämmer var de står, så vy, karta och test får samma svar.
