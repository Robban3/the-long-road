#!/usr/bin/env python3
"""Smoke tests for the generator, run against the Python port in `veil_level.py`.
...
the engine's arithmetic exactly (see the module docstring in `veil_level.py`), so a
