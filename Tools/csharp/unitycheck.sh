...
#   CS1656  assigning to something readonly
...
SIM=Tools/csharp/bin/Debug/net8.0/TheVeilTests.dll
...
# type inside System or TheVeil.Sim alongside the real ones is legal and harmless.
...
# the whole TheVeil menu off the menu bar with it, because a broken assembly takes every
